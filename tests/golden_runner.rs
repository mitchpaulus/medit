...
use medit::core::{
    ExAction, LspAction, Mode, ObjectKind, Registers, SearchState, Selection, Selections,
    collect_bytes, handle_ex, handle_insert, handle_normal, handle_search,
};
    ...
    loop {
        ...
        match mode {
            ...
            Mode::Ex => {
                ...
                // Buffer-list actions aren't dispatched in tests.
